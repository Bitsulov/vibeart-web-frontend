                ...
                <ol className={c.list}>
                    ...
                    <li className={c.subtitle}>
                        ...
                        <ol className={c.list}>
                            ...
                            <li className={c.list_item}>
                                {t("policy.text2_8", { url })}
                            </li>
                            <li className={c.list_item}>
                                {t("policy.text2_9", { url })}
                            </li>
