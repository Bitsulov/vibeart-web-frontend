    ...
    return (
        <section className={c.agreement_text} {...props}>
            <div className="container">
                ...
                <p className={c.paragraph}>{t("agreement.subtitle", { url })}</p>
                <ol className={c.list}>
                    ...
                    <li className={c.subtitle}>
                        ...
                        <ol className={c.list}>
                            ...
                            <li className={c.list_item}>
                                ...
                                <ol className={c.list}>
                                    <li className={c.list_item}>
                                        {t("agreement.text3_2_1")}
                                    </li>
                                    <li className={c.list_item}>
                                        {t("agreement.text3_2_2")}
                                    </li>
                                </ol>
                            </li>
                            <li className={c.list_item}>
                                ...
                                <ol className={c.list}>
                                    <li className={c.list_item}>
                                        {t("agreement.text3_3_1")}
                                    </li>
                                    <li className={c.list_item}>
                                        {t("agreement.text3_3_2")}
                                    </li>
                                </ol>
                            </li>
                            <li className={c.list_item}>
                        ...
                        <ol className={c.list}>
                            ...
                            <li className={c.list_item}>
                                ...
                                <ul className={c.list_ul}>
                                    <li className={c.list_item_ul}>
                                        {t("agreement.text5_6_1")}
                                    </li>
                                    <li className={c.list_item_ul}>
                                        {t("agreement.text5_6_2")}
                                    </li>
                                    <li className={c.list_item_ul}>
                                        {t("agreement.text5_6_3")}
                                    </li>
                                </ul>
                            </li>
