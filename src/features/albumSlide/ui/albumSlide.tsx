            ...
            {imageUrl ? (
                ...
                >
                    <g id="Layer_2">
                        <path
                            fill="currentColor"
                            d="M17.9,11.3c-0.5-0.8-1.3-1.3-2.3-1.3s-1.8,0.5-2.3,1.3L13,11.8L12,10.1c-0.5-0.9-1.5-1.4-2.5-1.4S7.6,9.2,7,10.1l-4.9,7.9   c-0.4,0.6-0.4,1.4-0.1,2c0.4,0.6,1,1,1.7,1h6.9h10c0.7,0,1.3-0.4,1.6-1c0.3-0.6,0.3-1.3,0-1.9L17.9,11.3z M9.1,18.1   c-0.1,0.1-0.2,0.3-0.2,0.4c0,0.1,0,0.1,0,0.2c0,0.1,0,0.2-0.1,0.3l-5,0l4.9-7.9c0.2-0.4,0.6-0.4,0.8-0.4s0.5,0,0.8,0.4l1.6,2.5   L9.1,18.1z M10.9,19l2-3.2l1-1.5c0,0,0,0,0,0l1.2-1.9c0.2-0.3,0.5-0.3,0.6-0.3c0.1,0,0.4,0,0.6,0.3l4.2,6.7H10.9z"
                        />
                        <path
                            fill="currentColor"
                            d="M15,5c0,1.7,1.3,3,3,3s3-1.3,3-3s-1.3-3-3-3S15,3.3,15,5z M19,5c0,0.6-0.4,1-1,1s-1-0.4-1-1s0.4-1,1-1S19,4.4,19,5z"
                        />
                    </g>
                </svg>
            )}
